...
class SleepNightAdapter(val clickListener: SleepNightListener) : ListAdapter<DataItem,
    ...
    //  (05) Change onCreateViewHolder's return type to RecyclerView.ViewHolder,
    ...
    //  (07) override getItemViewType() and check whether the item is a Header or a SleepNight.
